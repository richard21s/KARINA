...
export interface OAuthUser { 'principal' : Principal, 'email' : string }
...
export interface _SERVICE {
  ...
  'getOAuthUser' : ActorMethod<[Principal], [] | [OAuthUser]>,
  ...
  'loginWithOAuth' : ActorMethod<[Principal, string], string>,
